...
import mxMouseEvent from '../util/mx_mouse_event';

import mxConnector from '../shape/mx_connector';
import mxRectangleShape from '../shape/mx_rectangle_shape';
import mxText from '../shape/mx_text';
import mxEllipse from '../shape/mx_ellipse';
import mxRhombus from '../shape/mx_rhombus';
import mxCylinder from '../shape/mx_cylinder';
import mxActor from '../shape/mx_actor';
import mxTriangle from '../shape/mx_triangle';
import mxHexagon from '../shape/mx_hexagon';
import mxCloud from '../shape/mx_cloud';
import mxLine from '../shape/mx_line';
import mxArrow from '../shape/mx_arrow';
import mxArrowConnector from '../shape/mx_arrow_connector';
import mxDoubleEllipse from '../shape/mx_double_ellipse';
import mxSwimlane from '../shape/mx_swimlane';
import mxImageShape from '../shape/mx_image_shape';
import mxLabel from '../shape/mx_label';
import mxStencilRegistry from '../shape/mx_stencil_registry';
